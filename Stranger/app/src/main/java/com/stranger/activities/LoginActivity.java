...
import com.stranger.databinding.ActivityLoginBinding;
...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.viewGoogleButton.setOnClickListener(v ->
            signIn()
        );
    }
    ...
    private void updateUI(FirebaseUser user) {
        UserModel model = new UserModel(user.getUid(), user.getDisplayName(),user.getEmail(),
                user.getPhotoUrl().toString(),user.getPhoneNumber());
        model.setCity("Unknown");
        model.setCoins("500");
        references.child("user")
                .child(mAuth.getUid())
